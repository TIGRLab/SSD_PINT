...
```{r include=FALSE}
library(readxl)
COBRE_Data_Dictionary <- read_excel("/external/rprshnas01/tigrlab/external/SchizConnect/COBRE/COBRE_Data_Dictionary.xlsx", sheet = "COBRE Data Dictionary") 
...
schizconnect_COBRE_assessmentData_2963 <- read_csv("/external/rprshnas01/tigrlab/external/SchizConnect/COBRE/schizconnect_COBRE_assessmentData_2963.csv",
...
```
```{r include=FALSE}
cobre_participants <- read_csv("/external/rprshnas01/tigrlab/external/SchizConnect/COBRE/schizconnect_COBRE_assessmentData_2963.csv",
col_types = cols(question_value = col_character())) %>%
