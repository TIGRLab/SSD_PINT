...
![](prelim_pint_stats_20171122_files/figure-html/paired t tests of PINT effect-1.png)<!-- -->
...
vertex_type   subcort_ROI   PINT_ROI   term    statistic   p.value   p_FDR
------------  ------------  ---------  -----  ----------  --------  ------
...
vertex_type   subcort_ROI   YeoNet   term    statistic   p.value   p_FDR
------------  ------------  -------  -----  ----------  --------  ------
...
```
##  [1] "SiteZHH"           "SiteCOBRE"         "DXSSD"            
##  [4] "poly(Age_std, 2)1" "(Intercept)"       "mean_fd_pt"       
##  [7] "poly(Age_std, 2)2" "DXSSD:SexM"        "Edu_std"          
## [10] "SexM"
```
