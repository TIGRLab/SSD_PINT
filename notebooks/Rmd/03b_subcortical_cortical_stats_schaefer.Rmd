...
### Loading pre-read data from the cache
...
```{r plotting-PINT-change-matrix-reduce, fig.width=8, fig.height=6}
...
focus_results %>%
  ...
  ungroup() %>%
  mutate(subcort_ROI = factor(subcort_ROI, levels = c("cerebellum", "thalamus", "striatum")),
