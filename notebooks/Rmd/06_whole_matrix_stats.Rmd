...
[1] "node_name"    
"subcort_hemi" "subcort_ROI"  "subcort_NET"  "numvx"       
 [6] "size_is_ok"   "etype"        "cort_NET"     "cort_hemi"    "cort_lobe"   
[11] "network"      "hemi"         "subregion"
...
simpler_results <- results_pheno %>% 
  select(vertex_type, to, from, subject, dataset, weight, DX, lm_covar_cols)
```
